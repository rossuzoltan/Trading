...
DEFAULT_CHURN_MIN_HOLD_BARS = 0
DEFAULT_CHURN_ACTION_COOLDOWN = 0
DEFAULT_CHURN_PENALTY_USD = 0.1

# Phase 5: Reward Redesign Coefficients
DEFAULT_REWARD_DOWNSIDE_RISK_COEF = 0.0
DEFAULT_REWARD_TURNOVER_COEF = 0.0
