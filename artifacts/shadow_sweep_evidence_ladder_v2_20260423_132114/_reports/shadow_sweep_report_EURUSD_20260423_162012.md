...
* Window: `2026-04-23T11:21:14.135000+00:00` -> `2026-04-23T18:11:44.512000+00:00`
* Profiles: `8`

## Per-Profile
### p01_guarded_core
* Manifest hash: `b3356f616b4784716d25e46837b06cba15e6967ce701bab8da14fa17c1e8cfa5`
* Events: `6973` Trading days: `1` Actionable: `163`
* Opens: `82` Closes: `82` Holds: `492` Flat: `6318`
* Signals: `574` Rule-candidate: `574` Raw-price: `2228` Guard-blocked(raw): `1654`
* Guard failures (top): `spread_z_limit=1169, time_delta_z_limit=779`
* Rule blocks (top): `spread_z_limit=3738, price_z_threshold=1762, time_delta_z_limit=818`
* Est PnL (snapshot): `44.85` pips over `21` trades

### p02_guarded_plus
* Manifest hash: `27d36313a4630a59c2d373bac7f7323a9f1fd74b5a9692ff1efbcf9e7e61f52c`
* Events: `6973` Trading days: `1` Actionable: `181`
* Opens: `92` Closes: `92` Holds: `624` Flat: `6168`
* Signals: `716` Rule-candidate: `716` Raw-price: `2228` Guard-blocked(raw): `1512`
* Guard failures (top): `spread_z_limit=958, time_delta_z_limit=779`
* Rule blocks (top): `spread_z_limit=3219, price_z_threshold=2043, time_delta_z_limit=905, ma50_slope_limit=1`
* Est PnL (snapshot): `22.05` pips over `21` trades

### p03_centerline
* Manifest hash: `7c22706a8294a62d09322976461489e8470e0565127ecee32a1cdce989baca38`
* Events: `6973` Trading days: `1` Actionable: `190`
* Opens: `97` Closes: `97` Holds: `815` Flat: `5968`
* Signals: `912` Rule-candidate: `912` Raw-price: `2228` Guard-blocked(raw): `1316`
* Guard failures (top): `time_delta_z_limit=779, spread_z_limit=738`
* Rule blocks (top): `spread_z_limit=2771, price_z_threshold=2250, time_delta_z_limit=929, ma50_slope_limit=14, ma20_slope_limit=4`
* Est PnL (snapshot): `15.20` pips over `26` trades

### p04_spread_step
* Manifest hash: `5716e4b363b40be005bb5148d5f720346f6c3d7408c9b9edbf4e640dca35d4ba`
* Events: `6973` Trading days: `1` Actionable: `202`
* Opens: `103` Closes: `103` Holds: `859` Flat: `5912`
* Signals: `962` Rule-candidate: `962` Raw-price: `2228` Guard-blocked(raw): `1266`
* Guard failures (top): `time_delta_z_limit=779, spread_z_limit=683`
* Rule blocks (top): `spread_z_limit=2498, price_z_threshold=2344, time_delta_z_limit=1040, ma50_slope_limit=24, ma20_slope_limit=6`
* Est PnL (snapshot): `5.10` pips over `27` trades

### p05_slope_step
* Manifest hash: `ffc4269b0cb5ec35db41cc9a3938c9090b430d8a4e0001f451cd1c130a342a3f`
* Events: `6973` Trading days: `1` Actionable: `159`
* Opens: `80` Closes: `80` Holds: `520` Flat: `6294`
* Signals: `600` Rule-candidate: `600` Raw-price: `2228` Guard-blocked(raw): `1628`
* Guard failures (top): `spread_z_limit=1114, time_delta_z_limit=779`
* Rule blocks (top): `spread_z_limit=3639, price_z_threshold=1808, time_delta_z_limit=847`
...
* Signals: `912` Rule-candidate: `912` Raw-price: `2228` Guard-blocked(raw): `1316`
* Guard failures (top): `time_delta_z_limit=779, spread_z_limit=738`
* Rule blocks (top): `spread_z_limit=2771, price_z_threshold=2254, time_delta_z_limit=929, ma50_slope_limit=10, ma20_slope_limit=4`
* Est PnL (snapshot): `15.20` pips over `26` trades

### p07_upper_guardrail
* Manifest hash: `ac80ea01a30d4e56047068a2a8803fa01a972462864dd22f6980209c728c311c`
* Events: `6973` Trading days: `1` Actionable: `210`
* Opens: `107` Closes: `107` Holds: `867` Flat: `5896`
* Signals: `974` Rule-candidate: `974` Raw-price: `2228` Guard-blocked(raw): `1254`
* Guard failures (top): `time_delta_z_limit=779, spread_z_limit=653`
* Rule blocks (top): `price_z_threshold=2446, spread_z_limit=2371, time_delta_z_limit=1061, ma50_slope_limit=13, ma20_slope_limit=5`
...
* Events: `6973` Trading days: `1` Actionable: `224`
* Opens: `114` Closes: `114` Holds: `988` Flat: `5761`
* Signals: `1102` Rule-candidate: `1102` Raw-price: `2228` Guard-blocked(raw): `1126`
* Guard failures (top): `time_delta_z_limit=779, spread_z_limit=525`
* Rule blocks (top): `price_z_threshold=2701, spread_z_limit=1991, time_delta_z_limit=1064, ma50_slope_limit=4, ma20_slope_limit=1`
